FONT_5X8 = {
    ...
    0x33: [0x0E, 0x11, 0x01, 0x06, 0x01, 0x11, 0x0E, 0x00],  # 3
    ...
    0x44: [0x1E, 0x11, 0x11, 0x11, 0x11, 0x11, 0x1E, 0x00],  # D
    ...
    0x5C: [0x10, 0x08, 0x08, 0x04, 0x02, 0x02, 0x01, 0x00],  # backslash
...
_DEFAULT = [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]


def get_char_bitmap(ch: int) -> list[int]:
    return FONT_5X8.get(ch, _DEFAULT)
